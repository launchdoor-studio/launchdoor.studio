  ...
  return (
    <footer className="bg-ink text-white/80 mt-24">
      <Container className="py-20">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 flex flex-col-reverse md:flex-row md:items-center md:justify-between gap-4 text-[12.5px] text-white/50">
