          ...
          {services.map((service, i) => {
            ...
            return (
              <Link
                ...
                className={`group relative flex flex-col rounded-2xl bg-surface-raised ring-1 ring-surface-border p-7 hover:ring-ink/25 transition-all ${
              ...
              >
                ...
                <h3 className="mt-6 text-[19px] font-medium tracking-tight text-ink">
                  {service.title}
                </h3>
                <p className="mt-2 text-[14.5px] leading-relaxed text-ink-muted">
                  {service.summary}
                </p>
                <div className="mt-8 inline-flex items-center gap-1.5 text-[13px] font-medium text-ink-muted group-hover:text-brand transition-colors">
                  Learn more
                  <ArrowUpRight
                    size={14}
                    strokeWidth={2}
