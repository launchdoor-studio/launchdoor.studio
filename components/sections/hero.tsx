...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-20 md:pt-28 pb-20 md:pb-24">
      <div
        aria-hidden
      ...
      <Container>
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-surface-raised ring-1 ring-surface-border px-3 py-1 text-[12.5px] text-ink-muted">
            <span className="h-1.5 w-1.5 rounded-full bg-brand" />
            Software Studio · Product Engineering · AI Systems
          </div>

          <h1 className="mt-7 text-display-xl text-balance">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-full bg-ink px-5 py-3 text-[14px] font-medium text-white hover:bg-ink-soft transition-colors"
            >
              Start a Project
            ...
            <Link
              href="/work"
              className="inline-flex items-center gap-2 rounded-full bg-surface-raised px-5 py-3 text-[14px] font-medium text-ink ring-1 ring-surface-border hover:bg-white transition-colors"
            >
              View Our Work
            </Link>
          </div>
